  ...
  <div>
    <el-form :model="contractForm">
      ...
      <!-- <el-form-item label="签订乙方">
        <el-input
          v-model="contractForm.Bparty"
          placeholder="请输入签订乙方"
        ></el-input>
      </el-form-item> -->
      <el-form-item label="签订乙方">
        <el-select v-model="contractForm.sid" filterable placeholder="请选择乙方的姓名">
          <el-option
...
import { handlerContractInsert } from "../../http/contract";
...
export default defineComponent({
  setup() {
    // 表单
    let contractForm = reactive<ContractForm>({
      ctype: 1,
      cname: "",
      start: "",
      end: "",
    ...
    // 提交
    let handlerSubmit = () => {
      handlerContractInsert(contractForm)
        .then((res) => {
